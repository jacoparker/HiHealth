...
public class LoginActivityTest {
    ...
    // Test 1: Log in using a registered account
    @Test
    ...
    /* Tests that invalid values are not accepted
    If empty fields: Print required
    If tried to lo in using unregistered account: print Login failed
     */
    @Test
    public void loginActivityTest2() {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.login_email),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("notRegistered@gmail.com"), closeSoftKeyboard());

        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.login_email), withText("notRegistered@gmail.com"),
                        childAtPosition(
                                allOf(withId(R.id.container),
                                        childAtPosition(
                                                withId(android.R.id.content),
        ...
        ViewInteraction appCompatEditText6 = onView(
                allOf(withId(R.id.login_password), withText("12345"),
                        childAtPosition(
                                allOf(withId(R.id.container),
                                        childAtPosition(
                                                withId(android.R.id.content),
        ...
        ViewInteraction appCompatEditText7 = onView(
                allOf(withId(R.id.login_email), withText("ccdcdd"),
                        childAtPosition(
                                allOf(withId(R.id.container),
                                        childAtPosition(
                                                withId(android.R.id.content),
